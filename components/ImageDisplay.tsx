...
export const ImageDisplay: React.FC<ImageDisplayProps> = ({ imageUrls, referenceImage, isLoading, resolution, onGenerateAngles }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-6 h-full min-h-[400px]">
      ...
      {/* Main content area with source frame on left and render area on right */}
      <div className="relative w-full h-full max-h-[60vh] flex items-start gap-6">

        {/* Source Frame - Left aligned outside render area */}
        {referenceImage && (imageUrls.length > 0 || isLoading) && (
          <div className="flex-shrink-0 animate-in fade-in slide-in-from-left-4 duration-700 delay-300">
