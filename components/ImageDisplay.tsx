...
import { Download, Maximize2, X, ZoomIn, ZoomOut, RotateCcw, Image as ImageIcon, Check } from 'lucide-react';
...
export const ImageDisplay: React.FC<ImageDisplayProps> = ({ imageUrls, referenceImage, isLoading, resolution }) => {
          ...
          <div className={`grid ${gridClass} gap-6 w-full h-full`}>
            {imageUrls.map((url, idx) => (
              <div key={idx} className="relative aspect-video bg-[#121212] rounded-[2rem] border border-white/5 overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.4)] group">
                ...
                <div className="absolute bottom-6 right-6 z-30 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                  <button
