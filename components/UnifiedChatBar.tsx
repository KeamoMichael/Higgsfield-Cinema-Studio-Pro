...
export const UnifiedChatBar: React.FC<UnifiedChatBarProps> = ({
  ...
  const renderSelectionGrid = () => {
    ...
    return (
      <div className="absolute bottom-[calc(100%+24px)] left-0 w-[500px] max-h-[50vh] bg-[#0a0a0a]/90 backdrop-blur-2xl text-white rounded-[2rem] shadow-[0_40px_100px_rgba(0,0,0,0.9)] border border-white/10 overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300 z-[200]">
  ...
  const renderModalContent = () => {
    ...
    return (
      <div ref={modalRef} className="absolute bottom-[calc(100%+24px)] left-0 w-[340px] bg-[#0a0a0a]/90 backdrop-blur-2xl text-white rounded-[2rem] shadow-[0_40px_100px_rgba(0,0,0,0.9)] border border-white/10 overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300 z-[200]">
        <div className="p-6 border-b border-white/5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              <div className="relative" ref={menuRef}>
                ...
                {isAspectRatioMenuOpen && (
                  <div className="absolute bottom-[calc(100%+12px)] left-0 w-44 bg-[#0a0a0a]/90 backdrop-blur-2xl border border-white/10 rounded-[1.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.7)] overflow-hidden p-2 animate-in fade-in slide-in-from-bottom-3 duration-300 z-[200]">
